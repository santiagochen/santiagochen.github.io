...
<p align="center">
  <a href="https://santiagochen.com">
    <img alt="Gatsby" src="https://github.com/rolwin100/santiagochen_gatsby_blog/blob/master/src/images/icon.png" width="60" />
  </a>
</p>
<h1 align="center">
  Gatsby's santiagochen Portfolio template using <a href='https://ant.design/' target='_blank'>ant-design</a>
</h1>
...
1.  **Setup the project by.**
    ...
    git clone https://github.com/rolwin100/santiagochen_gatsby_blog.git
    cd santiagochen_gatsby_blog 
    npm install
    ```
